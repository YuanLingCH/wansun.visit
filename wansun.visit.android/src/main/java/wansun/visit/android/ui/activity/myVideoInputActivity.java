...
public class myVideoInputActivity extends AppCompatActivity {
    ...
    public static void startActivityForResult(Activity activity, int requestCode, int quality) {
        Intent intent = new Intent(activity, myVideoInputActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vedio_empty);
        quality = getIntent().getIntExtra("quality",Q480);
        LayoutInflater inflater=LayoutInflater.from(myVideoInputActivity.this);
    ...
    public void initialize(View view) {
        ...
        mPreview = new CameraPreview(myVideoInputActivity.this, mCamera);
