...
package wansun.visit.android.clusterutil.clustering.view;
...
import wansun.visit.android.clusterutil.MarkerManager;
import wansun.visit.android.clusterutil.clustering.Cluster;
import wansun.visit.android.clusterutil.clustering.ClusterItem;
import wansun.visit.android.clusterutil.clustering.ClusterManager;
import wansun.visit.android.clusterutil.projection.Point;
import wansun.visit.android.clusterutil.projection.SphericalMercatorProjection;
import wansun.visit.android.clusterutil.ui.IconGenerator;

import static wansun.visit.android.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        wansun.visit.android.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private wansun.visit.android.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        wansun.visit.android.clusterutil.ui.SquareTextView squareTextView =
                new wansun.visit.android.clusterutil.ui.SquareTextView(context);
