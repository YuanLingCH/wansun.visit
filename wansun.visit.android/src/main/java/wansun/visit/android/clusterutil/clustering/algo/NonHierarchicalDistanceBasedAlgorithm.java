...
import wansun.visit.android.clusterutil.projection.Bounds;
...
import wansun.visit.android.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, wansun.visit.android.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, wansun.visit.android.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                wansun.visit.android.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new wansun.visit.android.clusterutil.clustering.algo
